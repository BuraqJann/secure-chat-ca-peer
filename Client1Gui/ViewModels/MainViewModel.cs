...
namespace Client1Gui.ViewModels;

public sealed class MainViewModel : INotifyPropertyChanged
{
    // ✅ Client1 identity
    private const string MyId = "Client1";
    private const string ExpectedPeerId = "Client2";
    ...
    private string _listenIp = "10.0.0.11"; // Client1'in sanal IP'si (kendi ip'n neyse onu yaz)
    private int _listenPort = 6000;

    private string _peerIp = "10.0.0.12";
...
// Simple message model (XAML’in senin bubble template’ine uyuyor diye varsayıyorum)
